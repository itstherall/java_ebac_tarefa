...
public class Main {
	...
	public static void main(String[] args) {
		...
		todos.stream().filter(gen -> gen.genero == "feminino");
		...
		/*** IMPRIME LISTA DE MULHERES ***/
		System.out.println();
		System.out.println(" --------- LISTA DE MULHERES:  ");
		
		List<Pessoa> mulheres = filtrarMulheres(todos);
		
		mulheres.forEach(p -> System.out.println(p.nome));
		System.out.println();

	
	}
	
	public static void adicionarPessoa(Scanner adic, List<Pessoa> gente) {
	...
	public static List<Pessoa> filtrarMulheres(List<Pessoa> todos) {
        return todos.stream()
                    .filter(gen -> gen.genero.equalsIgnoreCase("feminino"))
